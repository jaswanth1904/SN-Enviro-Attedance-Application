    ...
    return (
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                ...
                <div className="md:col-span-2 m3-card-elevated p-10 bg-md-surface-container-high border-brand-primary/10 relative overflow-hidden group">
                ...
                <div className="m3-card-filled p-10 flex flex-col justify-between bg-md-surface-container border border-md-outline/5">
            ...
            <div className="m3-card-filled bg-md-surface-container-low border border-md-outline/10 overflow-hidden shadow-sm">
                        ...
                        {loading ? (
                            ...
                            salaries.map((salary, i) => (
                                <motion.div
                                    ...
                                    className="p-6 md:p-8 bg-md-surface-container-lowest/50 rounded-[28px] border border-md-outline/5 flex flex-col md:flex-row md:items-center justify-between gap-6 group hover:bg-md-surface-container transition-all"
                                >
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center gap-6">
                                        ...
                                        <motion.button
                                            whileTap={{ scale: 0.9 }}
                                            className="w-12 h-12 bg-md-surface-container text-md-on-surface-variant hover:text-brand-primary hover:bg-brand-primary/10 rounded-2xl flex items-center justify-center transition-all border border-md-outline/5"
                                        >
                                            <Download size={20} />
                                        </motion.button>
                                    </div>
